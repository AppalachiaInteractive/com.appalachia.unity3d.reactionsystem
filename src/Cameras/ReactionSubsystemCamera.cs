...
namespace Appalachia.Core.ReactionSystem.Cameras
{
    ...
    public abstract class ReactionSubsystemCamera : ReactionSubsystemBase
    {
        ...
        private static readonly ProfilerMarker _PRF_EnsureSubsystemCenterIsPrepared = new ProfilerMarker(_PRF_PFX + nameof(EnsureSubsystemCenterIsPrepared));
        protected static void EnsureSubsystemCenterIsPrepared(SubsystemCameraComponent cam, ReactionSubsystemCamera subsystem)
        {
