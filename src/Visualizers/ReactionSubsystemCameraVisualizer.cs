...
namespace Appalachia.Core.Visualizers
{
    ...
    {
        [PropertyOrder(-200)]
        public ReactionSubsystemCamera subsystem;
        ...
        protected override void GetVisualizationInfo(Vector3 position, float4 color, out float height, out Quaternion rotation, out Vector3 scale)
        {
            height = position.y;
